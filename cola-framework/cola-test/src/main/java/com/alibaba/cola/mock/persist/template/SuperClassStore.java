package com.alibaba.cola.mock.persist.template;
 ...
 * @date 2019/06/30
 */
public class SuperClassStore {
    private static final Logger logger = LoggerFactory.getLogger(SuperClassStore.class);
    private File file;
    private String srcResource;

    public SuperClassStore(String srcResource){
